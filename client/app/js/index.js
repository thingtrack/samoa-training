angular.module('SamoaApp', ['ngMaterial','md.data.table'])
	...
	.controller('sampleController', ['$mdEditDialog', '$q', '$scope', '$log', '$timeout', '$mdSidenav', function ($mdEditDialog, $q, $scope, $log, $timeout, $mdSidenav) {
		'use strict';
